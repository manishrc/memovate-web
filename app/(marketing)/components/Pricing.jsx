...
import { Logomark } from '@/app/(marketing)/components/Logo';
...
const plans = [
  {
    ...
    description:
      'Start your learning journey with essential features at no cost.',
    button: {
    ...
    features: [
      ...
      'Daily 10-minute recall sessions',
      'Track your progress',
      'Community support',
    ],
  ...
  },
  {
    ...
    description:
      'Enhance your learning with more resources and advanced features.',
    button: {
      label: 'Subscribe',
      href: '/register',
    },
    features: [
      ...
      'Daily 10-minute recall sessions with advanced tracking',
  ...
  },
  {
    ...
    description:
      'Master your learning with comprehensive tools and personalized support.',
    button: {
      label: 'Subscribe',
      href: '/register',
    },
